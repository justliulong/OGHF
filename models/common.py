...
class C2(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        ...
        self.m = nn.Sequential(*(Bottleneckv11(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0)
                                 for _ in range(n)))
...
class C2f(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        self.m = nn.ModuleList(Bottleneckv11(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
...
class C3k(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5, k=3):
        ...
        self.m = nn.Sequential(*(Bottleneckv11(c_, c_, shortcut, g, k=(k, k), e=1.0) for _ in range(n)))
...
class C3f(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        self.m = nn.ModuleList(Bottleneckv11(c_, c_, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
...
class SPPF(nn.Module):
    # Spatial Pyramid Pooling - Fast (SPPF) layer for YOLO by Glenn Jocher
...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        N = H * W
        qkv = self.qkv(x)
        q, k, v = qkv.view(B, self.num_heads, self.key_dim * 2 + self.head_dim,
                           N).split([self.key_dim, self.key_dim, self.head_dim], dim=2)
